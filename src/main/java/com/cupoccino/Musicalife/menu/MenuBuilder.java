package com.cupoccino.Musicalife.menu;
...
public class MenuBuilder {
	...
	private void buildMenu()
	{
		...
		playHeading.add( new MenuItem( 
				...
				"com.cupoccino.Musicalife.playlist.PlaylistViewMenuItem"
				));
		...
		playHeading.add( new MenuItem( 
				...
				"com.cupoccino.Musicalife.music.MusicViewMenuItem"
				));
		...
		playHeading.add( new MenuItem( 
				...
				"com.cupoccino.Musicalife.user.UserViewMenuItem"
				));	
		...
		maintainHeading.add( new MenuItem( 
				...
				"Add User",
				"Add a user",
				"com.cupoccino.Musicalife.menu.UndefinedMenuItem"
				));		
